  ...
  return (
    <div className="bg-login bg-cover bg-no-repeat w-screen h-screen mobile:h-full mobile:w-full mobile:bg-loginmobile">
        <div className="h-5/6 pt-10 flex justify-center items-center mobile:flex-col mobile:h-auto" >
            ...
            <div className="w-[400px] h-[510px] p-8 opacity-95 rounded-[30px] bg-backgroundLight relative  before:content-[''] before:absolute before:bg-secondary before:opacity-10 before:inset-0 before:-rotate-[4deg] before:-z-10 before:rounded-[30px] mobile:mt-10 mobile:mb-[90px]">
                <div>
                    <div className="">
                    ...
                    <div>
                        <form className="mt-6 flex flex-col gap-5 relative">
                            ...
                            <div className="w-40 ml-[11.5rem]">
                                <a className="font-open font-semibold text-sm hover:underline text-main items-end" href="#">Forgot password?</a>
                            </div>
                        ...
                        <div className="mt-5 text-sm text-secondary font-semibold ml-2 font-open ">
                            Don't have an account? <a className="text-main hover:underline" href="#">Create a free account!</a>
                        </div>
                    </div>
                </div>
            </div>
