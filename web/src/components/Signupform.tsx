...
export const Signupform = () => {
    ...
    return (
        <div>
            {true ? (
                <div>
                    <div className="w-[600px] h-[400px] self-center p-8 opacity-95 rounded-[30px] bg-backgroundLight relative  before:content-[''] before:absolute before:bg-secondary before:opacity-10 before:inset-0 before:-rotate-[4deg] before:-z-10 before:rounded-[30px] mobileSignup:w-[350px]">
                        <div className="">
                            <PaperPlaneTilt className="mr-auto ml-auto mt-2" color="#e8e4e6" size={45} weight={"bold"} />
                            <h1 className="font-open text-main text-center font-extrabold text-3xl mt-5">Almost there...</h1>
                            <p className="font-open text-secondary text-center font-bold mt-3">Please check your email {'true'}</p>
                        </div>
                    </div>
                </div>
                ) : (
