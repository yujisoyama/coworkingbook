...
export const sendAccountConfirmEmail = async (uuid: string, email: string, name: string) => {
    try {
        const mailSent = await transporter.sendMail({
            ...
            html: "<h2>Coworking Book Platform</h2> <p>Hi, " + name + "</p> <p>Click in the link below to confirm your email address and activate your account</p> <a href='http://15.228.154.83:3001/user/active/" + uuid + "' target='_blank'>Activate Account</a>",
        });
